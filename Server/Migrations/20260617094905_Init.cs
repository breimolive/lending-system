        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumber = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreformedById = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loans_Users_PreformedById",
                        column: x => x.PreformedById,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipment_CurrentLoanId",
                table: "Equipment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_PreformedById",
                table: "Loans",
                column: "PreformedById");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Equipment_Loans_CurrentLoanId",
                table: "Equipment",
                column: "CurrentLoanId",
